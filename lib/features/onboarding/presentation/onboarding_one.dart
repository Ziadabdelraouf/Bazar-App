import 'package:bazar_group_1/features/onboarding/presentation/onboarding_two.dart';
      ...
      SingleChildScrollView(
        child: Column(
          children: [
            ...
            Image.asset("assets/onboarding1.png",width: 320,height: 320,fit: BoxFit.contain,),
            Align(
              ...
              child: Padding(
                ...
                child: SizedBox(
                  width: 243,
                  height: 64,
                  child: Text("Now reading books will be easier",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w700,color: Color(0xff121212)),textAlign: TextAlign.center,)),
              )),
              Padding(
                ...
                child: SizedBox(
                  width: 292,
                  height: 72,
                  child: Text(" Discover new worlds, join a vibrant reading community. Start your reading adventure effortlessly with us.",
                  ...
                  children: [
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Text("Continue",style: TextStyle(color: Color(0xffFFFFFF),fontWeight: FontWeight.w700,fontSize: 16),textAlign: TextAlign.center,),
