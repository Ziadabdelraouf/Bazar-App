import 'package:bazar_group_1/features/onboarding/presentation/onboarding_three.dart';
        ...
        child: Column(
          children: [
           Padding(
            ...
            Image.asset("assets/onboarding2.png",width: 320,height: 320,fit: BoxFit.contain,),
            Align(
              ...
              child: Padding(
                ...
                child: SizedBox(
                  width: 291,
                  height: 64,
                  child: Text("Your Bookish Soulmate Awaits",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w700,color: Color(0xff121212)),textAlign: TextAlign.center,)),
              )),
              Padding(
                ...
                child: SizedBox(
                  width: 285,
                  height: 72,
                  child: Text(" Let us be your guide to the perfect read. Discover books tailored to your tastes for a truly rewarding experience.",
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    InkWell(
                      onTap: () {
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>OnboardingThree()));
                      },
                      child: Container(
                        width: 327,
                        height: 56,
